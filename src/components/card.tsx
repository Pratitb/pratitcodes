...
const Card: React.FC<CardType> = ({ screenshot, name, pills, url, github }) => {
    return (
        <div className="card-shdw rounded-lg p-4 bg-white border border-solid border-brdrShdwDividers overflow-hidden md:max-w-[48%] lg:max-w-[32%]">
            ...
            <div className="mt-3 min-w-0">
                ...
                <div className="flex flex-col gap-2 md:flex-row md:gap-4">
                    ...
                    <a href={github} target="_blank" className="text-[13px] text-primary uppercase underline decoration-emerald-400 decoration-2">github link</a>
                </div>
            </div>
        </div>
    );
